...
let myVarr = "lowercase m, lowercase v";
let MyVarr = "uppercase M, lowercase v";
let MYVARR = "all uppercase";

console.log("\nJavaScript identifiers are case-sensitive:");
console.log("myVarr =", myVarr);
console.log("MyVarr =", MyVarr);
console.log("MYVARR =", MYVARR);
...
console.log("\nNaming conventions (best practices):");
console.log("camelCase variables: firstNamee =", firstNamee, ", lastNamee =", lastNamee);
